...
#cist-link-detail-v2 .lf-advanced-body{padding:0 11px 11px}#cist-link-detail-v2 .lf-advanced:not([open])>.lf-advanced-body{display:none!important}#cist-link-detail-v2 .lf-advanced[open]>.lf-advanced-body{display:block!important}
...
@media(max-width:700px){.hero{padding-top:48px!important}.hero h1{font-size:clamp(42px,13vw,62px)!important}#cist-unified-home-scanner{width:calc(100% - 24px)!important;margin-top:22px!important}#cist-unified-home-scanner #scan-form{grid-template-columns:1fr!important}#cist-unified-home-scanner .input-wrap{grid-column:1!important;height:52px!important}#cist-unified-home-scanner #url{height:52px!important}#cist-unified-home-scanner #analyze{width:100%!important;height:48px!important}#cist-link-first-result .lf-verdict{padding:21px 18px 18px}#cist-link-first-result .lf-grid{grid-template-columns:1fr;padding:16px 18px 6px}#cist-link-first-result .lf-action{margin:10px 18px 0}#cist-link-detail-v2{margin:12px 18px 0}#cist-link-detail-v2 .lf-detail-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}#cist-link-detail-v2 .lf-detail-cell{padding:8px 9px}#cist-link-detail-v2 .lf-detail-cell strong{font-size:10px}#cist-link-first-result .lf-actions{padding:16px 18px 20px}#cist-link-first-result .lf-actions #cist-mega-share,#cist-link-first-result .lf-reset{flex:1}}
</style>
'''
...
function detailV2(d,r,rs){
  ...
  var chain=[],submitted=clean(input.value,500),chainTitle=reds.length?'Redirect chain':'Direct destination';
  if(reds.length){
    ...
    chain.push({label:status?'HTTP '+status:'Direct response',url:f?safeUrl(f):host});
  }
  ...
  return '<details id="cist-link-detail-v2"><summary><span class="lf-detail-head"><strong>Detailed analysis</strong><small>Evidence, redirects, response data and scan limits</small></span><span class="lf-detail-toggle">View details ↓</span></summary><div class="lf-detail-body">'+
    ...
    '<section class="lf-detail-section"><p class="lf-detail-kicker">Destination</p><h4>'+esc(chainTitle)+'</h4><div class="lf-detail-chain">'+chainHtml+'</div></section>'+
