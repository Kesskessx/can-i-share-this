...
def render_hub() -> str:
    ...
    description = 'Practical prevention guides for fake delivery texts, bank impersonation, account phishing, romance scams, job scams, marketplace fraud, tech support, crypto and more.'
