...
function buildCoverage(result){
  ...
  add('content','Content / context',Boolean(result&&result.originalInput)||Boolean(result&&result.analysis&&result.analysis.visible_text)||Boolean(result&&result.detectedType==='file'));
