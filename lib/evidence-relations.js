...
const NON_DOMAIN_TLDS = new Set([
  'pdf','doc','docx','xls','xlsx','ppt','pptx','zip','rar','7z','exe','msi','msix','scr','bat','cmd','ps1','vbs','jar','apk','dmg','pkg','iso','img','hta','appinstaller','jpg','jpeg','png','webp','gif','svg','mp3','mp4','mov','avi','mkv','txt','csv'
]);
